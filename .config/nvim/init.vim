" :help nvim-from-vim settings
set runtimepath^=~/.vim runtimepath+=~/.vim/after
let &packpath = &runtimepath
let g:python3_host_prog="/usr/local/bin/python3/" " python path

" bindings
" remap leader from '\' to '<space>'
nnoremap <SPACE> <Nop>
let mapleader = " "
" remaps Ctrl-w (window switching) to Leader-w
...
set signcolumn=yes:2 " persist signcolumn
set splitright
set splitbelow
...
" de-distract from vim
Plug 'junegunn/goyo.vim' " better focus
Plug 'junegunn/limelight.vim' " better focus
...
" vim-dirvish - netrw alternative
Plug 'justinmk/vim-dirvish'
let g:dirvish_mode = ':sort ,^.*[\/],' " sort folders top
