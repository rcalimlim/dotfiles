...
_pure_set_default pure_color_mute 5A5A5A
...
_pure_set_default pure_shorten_prompt_current_directory_length 3
...
_pure_set_default pure_color_git_dirty pure_color_warning
